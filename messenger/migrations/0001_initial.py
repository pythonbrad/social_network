# Generated by Django 2.0.13 on 2019-08-02 20:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=django.utils.timezone.now)),
                ('own', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='message_own', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='user',
            name='friends',
            field=models.ManyToManyField(related_name='user_friends', through='messenger.Friendship', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
